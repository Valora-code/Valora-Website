  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <h1 className="display-section mb-4">Integritetspolicy</h1>
        ...
        <div className="space-y-10 text-foreground/80 font-light leading-relaxed text-[15px]">
          <section>
            <h2 className="display-card mb-3">1. Personuppgiftsansvarig</h2>
            <p>
          ...
          <section>
            <h2 className="display-card mb-3">2. Vilka uppgifter vi samlar in</h2>
          ...
          <section>
            <h2 className="display-card mb-3">3. Rättslig grund och ändamål</h2>
          ...
          <section>
            <h2 className="display-card mb-3">4. Open Banking och bankdata</h2>
            <p>
          ...
          <section>
            <h2 className="display-card mb-3">5. Hur vi skyddar dina uppgifter</h2>
            <p>
          ...
          <section>
            <h2 className="display-card mb-3">6. Delning med tredje part</h2>
          ...
          <section>
            <h2 className="display-card mb-3">7. Lagringstid</h2>
            <p>
          ...
          <section>
            <h2 className="display-card mb-3">8. Dina rättigheter</h2>
          ...
          <section>
            <h2 className="display-card mb-3">9. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="display-card mb-3">10. Ändringar</h2>
            <p>
