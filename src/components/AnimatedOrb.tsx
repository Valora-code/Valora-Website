  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, hsl(172 50% 45% / 0.18) 0%, hsl(172 50% 45% / 0.06) 40%, transparent 70%)',
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, hsl(345 80% 75% / 0.1) 0%, hsl(345 80% 75% / 0.03) 50%, transparent 70%)',
          transform: 'translate(-50%, -50%)',
          animationDelay: '-3s',
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, hsl(325 90% 78% / 0.08) 0%, transparent 60%)',
          transform: 'translate(50%, -50%)',
          animationDelay: '-5s',
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at center, hsl(172 50% 45% / 0.08) 0%, transparent 70%)',
